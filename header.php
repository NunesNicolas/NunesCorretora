...
<head>
  ...
  <title><?php echo get_bloginfo('name'); ?><?php echo !is_front_page() ? ' | ' . wp_title('', false) : ''; ?></title>
  <link rel="icon" type="image/x-icon" href="<?php echo get_template_directory_uri(); ?>/assets/images/ico.ico">
  <style>
  :root {
